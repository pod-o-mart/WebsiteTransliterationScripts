// ==UserScript==
// @name            Cyrillic transliteration BGN/PCGN
// @description     Full-page Romanization of Cyrillic according to BGN/PCGN standards. Converts Cyrillic letters on web sites to Latin transliteration
// @source          https://userscripts-mirror.org./scripts/show/89931
// @identifier      https://userscripts-mirror.org./scripts/source/89931.user.js
// @version         1.0
// @date            2010-11-07
...
if(transliterate_rus1 == true)
	...
	+		'Ї:"Yi", ї:"yi", з:"z", Ѕ:"Dz", ѕ:"dz", И:"I", и:"i", І:"I", і:"i", Й:"Y", й:"y", К:"K", к:"k", Ќ:"K", ќ:"k",'
	+		'Л:"L", л:"l", Љ:"Lj", љ:"lj", Н:"N", н:"n", Њ:"Nj", њ:"nj", О:"O", о:"o", П:"P", п:"p", Р:"R", р:"r", С:"S", с:"s", Т:"T", т:"t",'
	+		'Ћ:"Ć", ћ:"ć", ж:"zh", Ѓ:"Ǵ", ѓ:"ǵ", Ђ:"Đ", ђ:"đ", З:"Z", Ј:"J", ј:"j", М:"M", м:"m", У:"u", у:"u", Ў:"W", ў:"w",'
	+		'Џ:"Dž", џ:"dž", Ф:"F", ф:"f", Х:"Kh", х:"kh", Ц:"Ts", ц:"ts", Ч:"Ch", ч:"ch", Ш:"Sh", ш:"sh", Щ:"Shch", Ъ:"’’", ъ:"’’", Ы:"Y", ы:"y", ь:"’", Ѣ:"Ye", ѣ:"ye", Ѫ:"U̐", ѫ:"u̐", Ѳ:"F", ѳ:"f", Ѵ:"Y", ѵ:"y",';
	}
