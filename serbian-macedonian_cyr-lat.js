// ==UserScript==
// @name            Serbian/Macedonian Cyrillic to Latin
// @description     Web site conversion of Serbian/Macedonian from Cyrillic to Latin
// @source          https://userscripts-mirror.org./scripts/show/89938
// @identifier      https://userscripts-mirror.org./scripts/source/89938.user.js
// @version         1.0
// @date            2010-11-07
...
if(transliterate_rus1 == true)
	...
	+		'Џ:"Dž", џ:"dž", Ф:"F", ф:"f", Х:"H", х:"h", Ц:"C", ц:"c", Ч:"Č", ч:"č", Ш:"Š", ш:"š", Щ:"Šč", Ъ:"’’", ъ:"’’", Ы:"Y", ы:"y", ь:"’", Ѣ:"Ě", ѣ:"ě", Ѫ:"Ȧ", ѫ:"ȧ", Ѳ:"Ḟ", ѳ:"ḟ", Ѵ:"Ẏ", ѵ:"ẏ",';
	}
